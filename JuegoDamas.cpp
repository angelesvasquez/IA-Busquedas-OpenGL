...
void applyMove(Board& b, const Move& move) {
    ...
    if (move.toRow == 0 && b.grid[move.toRow][move.toCol].getColor() == 0) {
        b.grid[move.toRow][move.toCol].crown(); // blancas llegan arriba
    }
    if (move.toRow == 7 && b.grid[move.toRow][move.toCol].getColor() == 1) {
        b.grid[move.toRow][move.toCol].crown(); // negras llegan abajo
    }
}
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Juego de Damas - OpenGL/GLUT");
